...
class ProductRoutes {
    ...
    initRoutes() {
        ...
        this.router.post(
            ...
            body("category").isString().isIn([Category["SMARTPHONE"], Category["LAPTOP"], Category["APPLIANCE"]]),
            body("quantity").isInt({min: 1}),
            body("details").optional({checkFalsy: true}).isString(),
            body("sellingPrice").isFloat({gt: 0}),
            body("arrivalDate").optional({checkFalsy: true}).isISO8601(),
        ...
        this.router.patch(
            ...
            body("quantity").isInt({min: 1}),
            body("changeDate").optional({checkFalsy: true}).isISO8601(),
            this.errorHandler.validateRequest,
        ...
        this.router.patch(
            ...
            param("model").isString().isLength({min: 1}),
            body("quantity").isInt({min: 1}),
            body("sellingDate").optional({checkFalsy: true}).isISO8601(),
            this.errorHandler.validateRequest,
        ...
        this.router.get(
            ...
            this.authenticator.isLoggedIn,
            this.authenticator.isAdminOrManager,
            query("grouping").isString().optional({checkFalsy: true}).isIn(["category", "model"]),
            query("category").isString().optional({checkFalsy: true}).isIn([Category["SMARTPHONE"], Category["LAPTOP"], Category["APPLIANCE"]]),
